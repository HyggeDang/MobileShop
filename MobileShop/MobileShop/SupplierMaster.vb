...
Public Class SupplierMaster
    ...
    Private Sub SupplierMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Dim cmd As New OleDbCommand("Select * from SupplierMaster", cn)
            cn.Open()
            ...
            Dim da As New OleDbDataAdapter("Select * from SupplierMaster", cn)
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        Try
            ...
            Else
                ...
                Dim cmd As New OleDbCommand("Select * from SupplierMaster where SupplierID=" & cmbID.Text, cn)
                cn.Open()
                Dim dr As OleDbDataReader = cmd.ExecuteReader
                While dr.Read
                    txtID.Text = dr(0)
    ...
    Private Sub btnModify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModify.Click
        Try
            ...
            Dim cmd As New OleDbCommand("Update SupplierMaster set Name='" & txtName.Text & "',Address='" & txtAdd.Text & "',City='" & txtCity.Text & "',Phno='" & txtPhno.Text & "',EMail='" & txtMail.Text & "' where SupplierID=" & txtID.Text, cn)
            cn.Open()
            cmd.ExecuteNonQuery()
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Dim cmd As New OleDbCommand("Insert into SupplierMaster Values(" & txtID.Text & ",'" & txtName.Text & "','" & txtAdd.Text & "','" & txtCity.Text & "','" & txtPhno.Text & "','" & txtMail.Text & "')", cn)
            cn.Open()
            cmd.ExecuteNonQuery()
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Try
            Dim cmd As New OleDbCommand("Delete from SupplierMaster where SupplierID=" & txtID.Text, cn)
            cn.Open()
            cmd.ExecuteNonQuery()

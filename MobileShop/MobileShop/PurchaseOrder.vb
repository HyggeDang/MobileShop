...
Public Class PurchaseOrder
    ...
    Private Sub GridSet()
        With FlexGrid
            ...
            .set_TextMatrix(0, 1, "ModelID Code")
    ...
    Private Sub PurchaseOrder_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Dim cmd As New OleDbCommand("Select * from OrderMaster", cn)
            cn.Open()
            ...
            Dim cmd1 As New OleDbCommand("Select * from SupplierMaster", cn)
            cn.Open()
    ...
    Private Sub cmbSId_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbSId.SelectedIndexChanged
        Try
            ...
            Dim cmd As New OleDbCommand("Select * from SupplierMaster where SupplierId=" & cmbSId.Text, cn1)
            cn1.Open()
            Dim dr As OleDbDataReader = cmd.ExecuteReader
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If Trim(cmbSId.Text) = "" Then
            MsgBox("Please Select Supplier Code", MsgBoxStyle.Exclamation, Me.Text)
            cmbSId.Focus()
            Exit Sub
        End If
        ...
        Try
            ...
            sql = "INSERT INTO OrderMaster VALUES(" & txtOno.Text & "," & _
            cmbSId.Text & ",'" & _
            DTP1.Text & "'," & _
            txtTotalAmt.Text & "," & _
            TempDis & "," & _
            ...
            With FlexGrid
                For i = 1 To .Rows - 1
                    ...
                    .Col = 4
                    AMT = .Text
                    sql = "INSERT INTO OrderDetail Values(" & txtOno.Text & "," & MID & "," & Qty & "," & Rate & "," & AMT & ")"
    ...
    Private Sub btnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFind.Click
        Try
            ...
            Dim cmd As New OleDbCommand("Select * from OrderMaster ORDER BY ONo", cn)
            cn.Open()
            Dim dr As OleDbDataReader = cmd.ExecuteReader
            cmbOno.Items.Clear()
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        If cmbOno.Text = "" Then
            MsgBox("Please Select Purchase Order Number", MsgBoxStyle.Exclamation, Me.Text)
            cmbOno.Focus()
            Exit Sub
        End If
        Try
            Dim sql As String
            cn.Open()
            sql = "select * from OrderMaster where ONo=" & cmbOno.Text & ""
            Dim Cmd As New OleDb.OleDbCommand(sql, cn)
            ...
            sql = "select * from OrderDetail where ONo=" & cmbOno.Text & ""
            Dim Cmd1 As New OleDb.OleDbCommand(sql, cn)
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Try
            Dim sql As String
            sql = "DELETE From OrderMaster where ONo=" & txtOno.Text & ""
            Dim cmd As New OleDb.OleDbCommand(sql, cn)
            cn.Open()
            cmd.ExecuteNonQuery()
            sql = "DELETE From OrderDetail where ONo=" & txtOno.Text & ""
            Dim cmd1 As New OleDb.OleDbCommand(sql, cn)
            cmd1.ExecuteNonQuery()
            cn.Close()
